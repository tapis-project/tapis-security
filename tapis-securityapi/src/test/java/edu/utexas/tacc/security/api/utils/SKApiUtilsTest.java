...
public class SKApiUtilsTest 
{
	...
	public void RestrictedServicePermissionsTest() 
	{
		...
		Assert.assertTrue(SKApiUtils.isValidRestrictedServicePermission(s));
		...
		// Invalid perms.
		s = "service:deny";
		Assert.assertFalse(SKApiUtils.isValidRestrictedServicePermission(s));

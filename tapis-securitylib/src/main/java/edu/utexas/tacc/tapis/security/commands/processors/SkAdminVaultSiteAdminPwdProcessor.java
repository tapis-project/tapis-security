...
public final class SkAdminVaultSiteAdminPwdProcessor
 extends SkAdminSiteAdminPwdProcessor
{
    /* ********************************************************************** */
    /*                               Constants                                */
    /* ********************************************************************** */
    // Tracing.
    private static final Logger _log = LoggerFactory.getLogger(SkAdminVaultSiteAdminPwdProcessor.class);
    ...
    /* constructor:                                                           */
    /* ---------------------------------------------------------------------- */
    public SkAdminVaultSiteAdminPwdProcessor(List<SkAdminSiteAdminPwd> secrets,
    ...
    {
        _log.debug("Creating Site Admin Password Secrets (VAULT)");
